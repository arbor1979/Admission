...
public class Expressions {
	...
	public static int[] expressionImgs1 = new int[] { R.drawable.f000,
	...
	public static String[] expressionImgNames1 = new String[] { "[f000]",
	...
	public static int[] expressionImgs2 = new int[] { R.drawable.f024,
	...
	public static String[] expressionImgNames2 = new String[] { "[f024]",
	 ...
	 * 本地表情的名称组3
	 */
	public static int[] expressionImgs3 = new int[] { R.drawable.f048,
	...
	public static String[] expressionImgNames3 = new String[] { "[f048]",
