...
import com.dandian.admission.activity.AlbumShowImageDetail;
...
public class AlbumImageFragment extends Fragment{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if(image.getPraiseList().size()>0)
		{
			...
			/*
			LayoutParams linearParams = (LinearLayout.LayoutParams)mGrid.getLayoutParams(); // ÂèñÊéß‰ª∂mGridÂΩìÂâçÁöÑÂ∏ÉÂ±?ÂèÇÊï∞
