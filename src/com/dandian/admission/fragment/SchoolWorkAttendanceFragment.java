...
import com.dandian.admission.entity.WorkAttendanceItem;
import com.dandian.admission.entity.WorkAttendanceItem.SelectByWeek;
import com.dandian.admission.entity.WorkAttendanceItem.SelectShortCut;
import com.dandian.admission.entity.WorkAttendanceItem.WorkAttendance;
...
public class SchoolWorkAttendanceFragment extends Fragment {
	...
	public SchoolWorkAttendanceFragment(String title, String iunterfaceName) {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		try {
			...
			user = userDao.queryBuilder().where().queryForFirst();
	...
	private void initDate() {
		...
		if (user.getUserType().equals("老师")) {
			...
			aq.id(R.id.tv_user_type).text("用户类型:学生");
			aq.id(R.id.tv_class_or_department).text("班级:" + wAttendance.getsClass());
		}
		final String imgUrl = wAttendance.getUserPic();
		if (imgUrl != null) {
			ImageOptions options = new ImageOptions();
