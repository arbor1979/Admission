...
import com.dandian.admission.entity.WorkAttendanceDetail;
import com.dandian.admission.entity.WorkAttendanceDetail.AttendanceValue;
...
public class SchoolWorkAttendanceDetailFragment extends Fragment {
	...
	public SchoolWorkAttendanceDetailFragment(String title, String iunterfaceName) {
		this.title = title;
