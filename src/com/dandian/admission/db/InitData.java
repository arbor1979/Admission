...
import com.dandian.admission.entity.AllInfo;
import com.dandian.admission.entity.ChatFriend;
import com.dandian.admission.entity.ChatMsg;
import com.dandian.admission.entity.ContactsInfo;
...
import com.dandian.admission.util.SerializableMap;
import com.dandian.admission.util.WifiUtility;
import com.dandian.admission.util.ZLibUtils;
import com.dandian.admission.util.ZipUtility;
		...
		public void handleMessage(Message msg) {
			...
			case 6:// 上传设备信息
				...
				try {
					...
					JSONArray richeng=jowasr.optJSONArray("未来日程"); 
					if(richeng!=null)
					{
						try {
